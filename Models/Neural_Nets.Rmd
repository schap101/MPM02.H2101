...
```{r}
set.seed(42)
tmodel = neuralnet(cnt ~ temp + hum + hr_1 + hr_2 + hr_3 + hr_4 + hr_5 + hr_6 + hr_7 + hr_8 + hr_9 + hr_10 + hr_11 + hr_12 + hr_13 + hr_14 + hr_15 + hr_16 + hr_17 + hr_18 + hr_19 + hr_20 + hr_21 + hr_22 + hr_23, data = train, hidden = c(4,2), threshold = 0.015, stepmax = 1e+06, rep = 1, lifesign = "full", lifesign.step = 1000, linear.output = TRUE, act.fct = "logistic")
```
...
```{r}
plot(control, pred, col='orange', pch=20, cex = .3, ylab = "predicted rating NN", xlab = "real rating")
abline(0,1)
```
...
```{r}
set.seed(42)
tmodel_2 = neuralnet(cnt ~ temp + weathersit_1 + weathersit_2 + weathersit_3 + hr_1 + hr_2 + hr_3 + hr_4 + hr_5 + hr_6 + hr_7 + hr_8 + hr_9 + hr_10 + hr_11 + hr_12 + hr_13 + hr_14 + hr_15 + hr_16 + hr_17 + hr_18 + hr_19 + hr_20 + hr_21 + hr_22 + hr_23, data = train, hidden = c(18), threshold = 0.02, stepmax = 1e+06, rep = 1, lifesign = "full", lifesign.step = 1000, linear.output = TRUE, act.fct = "logistic")
```
...
```{r}
pred_2 <- compute(tmodel_2, test %>% select(-cnt))
pred_2 <- pred_2$net.result * (max(df$cnt) - min(df$cnt)) + min(df$cnt)
control_2 <- test$cnt * (max(df$cnt) - min(df$cnt)) + min(df$cnt)
head(pred_2)
head(control_2)
```
...
```{r}
set.seed(42)
tmodel_3 = neuralnet(cnt ~ hum + temp + weathersit_1 + weathersit_2 + weathersit_3 + hr_1 + hr_2 + hr_3 + hr_4 + hr_5 + hr_6 + hr_7 + hr_8 + hr_9 + hr_10 + hr_11 + hr_12 + hr_13 + hr_14 + hr_15 + hr_16 + hr_17 + hr_18 + hr_19 + hr_20 + hr_21 + hr_22 + hr_23, data = train, hidden = c(3,2), threshold = 0.1, stepmax = 1e+05, rep = 1, lifesign = "full", lifesign.step = 1000, linear.output = TRUE, act.fct = "logistic")
```
...
#3.1 Model 4 - Train and compare
```{r}
models_4 <- train(cnt ~ hum + temp + weathersit_1 + weathersit_2 + weathersit_3 + hr_1 + hr_2 + hr_3 + hr_4 + hr_5 + hr_6 + hr_7 + hr_8 + hr_9 + hr_10 + hr_11 + hr_12 + hr_13 + hr_14 + hr_15 + hr_16 + hr_17 + hr_18 + hr_19 + hr_20 + hr_21 + hr_22 + hr_23, data = train,
  method = 'neuralnet',
  metric = 'RMSE',
  linear.output = TRUE,
  threshold = 0.1,
...
```{r}
saveRDS(models_4, "neural_nets_models_1")
```


```{r}
models_k <-readRDS("neural_nets_models_1")
```
